        ...
        function () {
            ...
            this.construct = function (settings) {
                return this.each(function () {
                    ...
                    actualClicks = document.getElementsByClassName("want_to_click");

                    $headers.click(

                    function (e) {
                        var returnNothing = true;
                        for (var i = 0; i < actualClicks.length; i++){
                            if(actualClicks.item(i) == e.target) returnNothing = false;
                        }   
                        if(returnNothing){
                            return;
                        }
