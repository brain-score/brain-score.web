...
const waybackMinEl = document.getElementById('waybackDateMin');
const waybackMaxEl = document.getElementById('waybackDateMax');

const waybackMin = waybackMinEl?.value ? new Date(waybackMinEl.value) : null;
const waybackMax = waybackMaxEl?.value ? new Date(waybackMaxEl.value) : null;

window.activeFilters.wayback_min = waybackMin;
window.activeFilters.wayback_max = waybackMax;
